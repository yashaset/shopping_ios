    ...
    var body: some View {
        VStack(alignment: /*@START_MENU_TOKEN@*/.center/*@END_MENU_TOKEN@*/, spacing: 25){
            Image("bg")
                ...
                .clipShape(RoundedRectangleShape.init(corners: [.bottomLeft, .bottomRight], radius: 50))
            ...
            Spacer()
            Text("\(fruit.rawValue) - Medium").fontWeight(.medium).font(.system(.title)).padding(.horizontal).textCase(/*@START_MENU_TOKEN@*/.uppercase/*@END_MENU_TOKEN@*/)
            Text("Each (500g - 700g)")
                .padding(.horizontal)
